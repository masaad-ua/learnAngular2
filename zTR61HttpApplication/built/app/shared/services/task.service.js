System.register(["@angular/core", "@angular/http", "rxjs/Observable"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, TaskService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            TaskService = /** @class */ (function () {
                function TaskService(http) {
                    //Опишем их роли подробно. Конструктор инициализирует экземпляр
                    //наблюдаемого (Observable) объекта и присваивает встроенного наблюдателя (observer)
                    //свойству для наблюдения.
                    var _this = this;
                    this.http = http;
                    this.taskStore = [];
