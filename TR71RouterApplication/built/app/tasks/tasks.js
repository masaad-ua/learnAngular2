System.register(["./tasks.component", "./task-editor.component", "./task-tooltip.directive"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var tasks_component_1, task_editor_component_1, task_tooltip_directive_1, TASKS_DIRECTIVES;
    return {
        setters: [
