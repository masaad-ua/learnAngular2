        ...
        execute: function() {
            LoginComponent = (function () {
                ...
                LoginComponent.prototype.authenticated = function () {
                    //Метод authenticate () сначала связывает свойство value группы
                    //элементов loginForm с переменной credentials. Как вы уже знаете,
                    //loginForm.value хранит объект хэша следующего вида:
                    //{ username: "", password: "" }
                    var _this = this;
